...
export function ContactCta() {
  const whatsapp = buildWhatsAppUrl(
    "Hi Jhakash Printing Gift! I have an idea for a custom T-shirt.",
  );
  ...
  return (
    <section
      id="contact"
      className="scroll-mt-24 px-4 py-16 sm:px-6 md:px-8 lg:px-10 lg:py-24"
    >
      <Reveal
        variant="scale"
        className="page-shell relative overflow-hidden rounded-[36px] bg-charcoal text-cream shadow-[0_24px_60px_rgba(41,38,36,0.18)]"
      >
        ...
        <div className="relative grid items-center gap-8 p-8 sm:p-10 md:grid-cols-[1.3fr_0.9fr] md:gap-12 md:p-12 lg:p-16">
          ...
          <Reveal
            variant="right"
            delay={180}
            className="relative mx-auto w-52 sm:w-56 md:w-64 lg:w-72"
          >
